...
globalThis.SharpSleeve=(()=>{
 ...
 function build(source,o){
  ...
  const artwork=(o.designs||[o]).filter(d=>d.heightmap).map(d=>({...d,contour:contourField(d.sharp===false?{...d,heightmap:Float32Array.from(d.heightmap,v=>Math.min(1,v*500))}:d)}));
